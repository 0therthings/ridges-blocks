...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/grid/editor.scss");
...
function Edit(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    ...
    onChange: mobileColumns => setAttributes({
      mobileColumns
    }),
    min: 1,
    max: 3
...
function save(props) {
  ...
  let className = `simple-grid simple-grid--${attributes.columns} simple-grid--mobile-${attributes.mobileColumns} simple-grid--spacing-${attributes.spacing}`;
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["grid/style-index"], () => (__webpack_require__("./src/grid/index.js")))
